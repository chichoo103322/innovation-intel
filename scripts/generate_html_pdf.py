...
**什么是**：京津冀、长三角、大湾区城市群；成都、重庆、武汉、西安等中西部城市；29座GDP万亿城市正式印发的创新政策——行动方案、行动计划、管理办法、实施意见、若干措施、试点办法、专项资金/补贴政策。
**不是什么（以下类型严格排除）**：
- ❌ 会议/论坛/活动新闻（如"某某大会在某地举办"）——政策板块不放活动
- ❌ 领导调研/考察/走访/座谈会——调研不是政策
- ❌ 常州本地新闻（常州政策应放在洞察中作为对标依据，而非作为本板块"外部信息"出现）
...
🔴 **硬约束：必须是万亿城市正式印发的科技创新政策文件，有明确文件名（用《》括起来）。**
**什么是**：行动方案、行动计划、管理办法、实施意见、若干措施、试点办法、专项资金/补贴政策。
**不是什么（严格排除）**：
- ❌ 会议/论坛/活动新闻（如"某某大会在某地举办"）——政策板块不放活动
- ❌ 领导调研/考察/走访/座谈会——调研不是政策
- ❌ 常州本地新闻（常州政策应放在洞察中作为对标依据，而非作为本板块"外部信息"出现）
- ❌ 缺乏正式文件名的泛泛报道
⚠️ 重点搜索万亿城市五大产业方向相关政策文件

第一轮（政务官方强制——搜索正式印发文件）：
- site:gov.cn "行动方案" OR "行动计划" OR "管理办法" OR "实施意见" OR "若干措施" OR "试点办法" "科技" "2026"
- site:gov.cn "科技创新" "印发" "方案" OR "办法" OR "措施" "2026"

第二轮（万亿城市定向政策文件搜索）：
- "苏州" OR "武汉" OR "深圳" OR "成都" OR "南京" OR "杭州" OR "合肥" OR "无锡" OR "宁波" "科技创新" "行动方案" OR "行动计划" OR "办法" "印发" "2026"
- site:gov.cn "AI数据中心" OR "智算中心" OR "算力补贴" "方案" OR "办法" "2026"
- site:gov.cn "具身智能" OR "人形机器人" "行动计划" OR "方案" "2026"
- site:gov.cn "氢能" OR "新型储能" OR "钙钛矿" "政策" OR "补贴" OR "方案" "2026"

第三轮（万亿城市对标搜索——确保有文件名）：
- "长三角" OR "大湾区" OR "京津冀" "万亿城市" "科技创新" "行动方案" "印发" "2026"
- 每轮搜索后强制检查：搜到的内容是否有明确的政策文件名？无文件名的内容不纳入本板块。
...
🔴 **硬约束：必须是万亿城市正式印发的科技创新政策文件，有明确文件名（用《》括起来）。**
**什么是**：京津冀、长三角、大湾区城市群；成都、重庆、武汉、西安；29座GDP万亿城市正式印发的创新政策——行动方案、行动计划、管理办法、实施意见、若干措施、试点办法、专项资金/补贴政策。
...
⚠️ 重点搜索万亿城市五大产业方向政策文件
政务官方：
- site:gov.cn "行动方案" OR "行动计划" OR "管理办法" OR "实施意见" OR "若干措施" OR "试点办法" "科技" "2026"
- site:gov.cn "科技创新" "印发" "方案" OR "办法" OR "措施" "2026"
万亿城市定向：
- site:beijing.gov.cn OR site:shenzhen.gov.cn OR site:nanjing.gov.cn OR site:suzhou.gov.cn OR site:wuhan.gov.cn "科技创新" "行动方案" OR "行动计划" "印发" "2026"
- "苏州" OR "武汉" OR "深圳" OR "成都" OR "南京" OR "杭州" OR "无锡" "科技创新" "行动方案" OR "行动计划" OR "办法" "2026"
- site:gov.cn "具身智能" OR "人形机器人" "行动计划" OR "方案" "2026"
- site:gov.cn "氢能" OR "新型储能" OR "钙钛矿" "政策" OR "补贴" OR "方案" "2026"
注意：每轮搜索后强制检查——搜到的内容是否有明确的政策文件名？无文件名的内容不纳入本板块。
