...
def call_deepseek_for_weekly(api_key, model, daily_texts, today_cn):
    ...
    system = """你是资深科技创新情报分析师，服务于常州市科技创新决策。
请根据本周日报内容，生成一份周报。你需要：

1. 本周综述（200-300字）：归纳本周核心主线、关键信号
2. 每周维度分述：各维度本周要点总结
3. 趋势研判（2-3条）：基于本周信息发现的新趋势
4. 对常州的建议（2-3条）：结合常州实际提出行动建议

输出纯 JSON（不要其他文字）：
{
  "weekly_overview": "本周综述...",
  "trends": ["趋势1", "趋势2"],
  "suggestions": ["建议1", "建议2"],
  "sections": [
    {"name": "各地科技委动态", "overview": "...", "highlights": ["要点1", "要点2"]},
